package.preload["lililine.aniseed.fennel.repl"] = package.preload["lililine.aniseed.fennel.repl"] or function(...)
  local utils = require("lililine.aniseed.fennel.utils")
  local parser = require("lililine.aniseed.fennel.parser")
  local compiler = require("lililine.aniseed.fennel.compiler")
  local specials = require("lililine.aniseed.fennel.specials")
...
package.preload["lililine.aniseed.fennel.view"] = package.preload["lililine.aniseed.fennel.view"] or function(...)
...
package.preload["lililine.aniseed.fennel.specials"] = package.preload["lililine.aniseed.fennel.specials"] or function(...)
  local utils = require("lililine.aniseed.fennel.utils")
  local view = require("lililine.aniseed.fennel.view")
  local parser = require("lililine.aniseed.fennel.parser")
  local compiler = require("lililine.aniseed.fennel.compiler")
  ...
  local function metadata_only_fennel(modname)
    if ((modname == "lililine.aniseed.fennel.macros") or (package and package.loaded and ("table" == type(package.loaded[modname])) and (package.loaded[modname].metadata == compiler.metadata))) then
...
package.preload["lililine.aniseed.fennel.compiler"] = package.preload["lililine.aniseed.fennel.compiler"] or function(...)
  local utils = require("lililine.aniseed.fennel.utils")
  local parser = require("lililine.aniseed.fennel.parser")
  local friend = require("lililine.aniseed.fennel.friend")
  local unpack = (table.unpack or _G.unpack)
  local scopes = {}
...
package.preload["lililine.aniseed.fennel.friend"] = package.preload["lililine.aniseed.fennel.friend"] or function(...)
  local function ast_source(ast)
    local m = getmetatable(ast)
    return ((m and m.line and m) or (("table" == type(ast)) and ast) or {})
  end
...
package.preload["lililine.aniseed.fennel.parser"] = package.preload["lililine.aniseed.fennel.parser"] or function(...)
  local utils = require("lililine.aniseed.fennel.utils")
  local friend = require("lililine.aniseed.fennel.friend")
  local unpack = (table.unpack or _G.unpack)
...
local utils = nil
package.preload["lililine.aniseed.fennel.utils"] = package.preload["lililine.aniseed.fennel.utils"] or function(...)
...
utils = require("lililine.aniseed.fennel.utils")
local parser = require("lililine.aniseed.fennel.parser")
local compiler = require("lililine.aniseed.fennel.compiler")
local specials = require("lililine.aniseed.fennel.specials")
local repl = require("lililine.aniseed.fennel.repl")
local view = require("lililine.aniseed.fennel.view")
...
do
  ...
  local module_name = "lililine.aniseed.fennel.macros"
  local _ = nil
  local function _0_()
    return mod
  end
