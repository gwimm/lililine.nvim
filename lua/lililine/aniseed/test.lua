local _0_0
do
  local name_0_ = "lililine.aniseed.test"
  local module_0_
  do
...
local function _1_(...)
  ...
  local function _1_()
    return {autoload("lililine.aniseed.core"), autoload("lililine.aniseed.nvim"), autoload("lililine.aniseed.string")}
  end
  ok_3f_0_, val_0_ = pcall(_1_)
  if ok_3f_0_ then
    _0_0["aniseed/local-fns"] = {autoload = {a = "lililine.aniseed.core", nvim = "lililine.aniseed.nvim", str = "lililine.aniseed.string"}}
    return val_0_
  else
    return print(val_0_)
  end
...
local _2amodule_name_2a = "lililine.aniseed.test"
