local _0_0
do
  local name_0_ = "lililine.aniseed.fennel"
  local module_0_
  do
    ...
    if ("table" == type(x_0_)) then
      ...
      module_0_ = require("lililine.aniseed.deps.fennel")
    end
  end
...
local function _1_(...)
  ...
  local function _1_()
    return {autoload("lililine.aniseed.deps.fennel"), autoload("lililine.aniseed.nvim")}
  end
  ok_3f_0_, val_0_ = pcall(_1_)
  if ok_3f_0_ then
    _0_0["aniseed/local-fns"] = {autoload = {fennel = "lililine.aniseed.deps.fennel", nvim = "lililine.aniseed.nvim"}}
    return val_0_
  else
    return print(val_0_)
  end
...
local _2amodule_name_2a = "lililine.aniseed.fennel"
